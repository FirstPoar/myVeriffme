...
//array("firstName"=>"=Topor",
//    "lastName"=>"Topor");
   $data = array(
			"id" => "4e01d4cc-db4b-428d-82b4-e5be21b684d2",
				"lang"=>"ru",
				"person"=> array(
			"idNumber"=>"12345678",
			"lastName"=>"Topor",
			...
			"callback"=> "https://office.veriff.me",
				"document"=> array(
			"type"=>"ID_CARD",
			"number"=>"12345678",
			"country"=> "UA"
			...
			"timestamp"=>"2018-03-31T07:56:34.576Z"
		);
...
$ch = curl_init('https://api.veriff.me/v1/');
